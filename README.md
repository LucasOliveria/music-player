...
<p style="text-align: justify;">
    O objetivo desse projeto foi desenvolver uma aplicação web utilizando o React e suas funcionalidades. Com essa magnífica biblioteca para web e interfaces de usuário nativas foi possível criar essa aplicação que se trata de um mini {c:#E5007B}**Player de Música**{/c}. Para produzir o layout foi utilizado o arquivo figma disponibilizado pela {c:#E5007B}**Cubos Academy**{/c} na aula de desafios React, onde pude aprimorar e por em prática meus conhecimentos.
</p>
